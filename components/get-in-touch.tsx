    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex items-center justify-center rounded-xl shrink-0"></div>
            ...
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif", color: "#888" }}
            >
              A 36-hour hackathon where ideas collide, code comes alive, and the
              next big thing begins.
            </p>
          ...
          >
            <p
              className="text-[9px] uppercase tracking-[0.48em] font-bold mb-1"
            ...
            {[
              {
                icon: <EmailIcon />,
                text: "mlsa.community@miet.ac.in",
                href: "mailto:mlsa.community@miet.ac.in",
                accent: "#5BA4E6",
              },
              {
                icon: <EmailIcon />,
                text: "prafullit.bhattacharya.cseds.2023@miet.ac.in",
                href: "mailto:prafullit.bhattacharya.cseds.2023@miet.ac.in",
                accent: "#D85C8A",
              },
              {
                icon: <PhoneIcon />,
                text: "+91 81719 98021",
                href: "tel:+918171998021",
                accent: "#4CAF50",
              },
              {
                icon: <PhoneIcon />,
                text: "+91 89419 20553",
                href: "tel:+918941920553",
                accent: "#4CAF50",
              },
              {
                icon: <PinIcon />,
                text: "N.H. 58, Delhi-Roorkee Highway, Baghpat Bypass Road Crossing, Meerut, UP 250005",
                href: MAPS_URL,
                accent: "#E8916E",
              },
            ].map((item, i) => (
          ...
          {/* ── COL 3: Quick Links ── */}
          <motion.div
            className="flex flex-col gap-2 md:ml-6"
            initial={{ opacity: 0, y: 20 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{
              duration: 0.55,
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, #CFE8FF 20%, #FFE9A8 40%, #D7F5D0 60%, #FFD6E8 80%, transparent)",
          }}
          initial={{ scaleX: 0, opacity: 0 }}
          animate={inView ? { scaleX: 1, opacity: 1 } : {}}
