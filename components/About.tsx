  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(140deg, rgba(255,255,255,0.55) 0%, transparent 50%)",
        }}
      />
      {/* Dot grid */}
      <div
      ...
      {/* Label */}
      <p
        className="relative z-10 text-[9px] uppercase tracking-[0.38em] font-semibold"
...
function VSep({ color, delay }: { color: string; delay: number }) {
  ...
  return (
    <div
      ref={ref}
      className="hidden md:flex flex-col items-center gap-1.5 shrink-0 self-stretch py-6 md:ml-6"
    >
      <motion.div
        className="w-[1.5px] flex-1 rounded-full"
        style={{
          background: `linear-gradient(to bottom, transparent, ${color}70 30%, ${color}70 70%, transparent)`,
        }}
      ...
      <motion.div
        className="w-[1.5px] flex-1 rounded-full"
        style={{
          background: `linear-gradient(to bottom, ${color}70 30%, ${color}70 70%, transparent)`,
        }}
        initial={{ scaleY: 0, opacity: 0 }}
        animate={inView ? { scaleY: 1, opacity: 1 } : {}}
        transition={{
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          backgroundImage: `radial-gradient(${feat.accent}28 1px, transparent 1px)`,
      ...
      <motion.div
        className="absolute top-0 left-0 right-0 h-[3px]"
        style={{
          background: `linear-gradient(90deg, transparent, ${feat.accent}bb 35%, ${feat.accent} 50%, ${feat.accent}bb 65%, transparent)`,
          borderRadius: "16px 16px 0 0",
        }}
        initial={{ scaleX: 0, opacity: 0 }}
        animate={inView ? { scaleX: 1, opacity: 1 } : {}}
      ...
      {/* Corner pip */}
      <div
        className="absolute top-3 right-3 w-1.5 h-1.5 rounded-full opacity-50"
      ...
      <div className="relative z-10 flex flex-col gap-3 p-6 pb-4">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(90deg, ${feat.accent}40, transparent)`,
          }}
        />
      ...
      <div className="relative z-10 mt-auto mx-4 mb-4">
        ...
        <div
          className="h-px mb-3"
          style={{
            background: `linear-gradient(90deg, transparent, ${feat.accent}38, transparent)`,
          }}
        />
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div ref={titleRef} className="text-center mb-10">
          ...
          >
            What is <span style={{ color: "#5BA4E6" }}>DevGathering?</span>
          </motion.h2>
          ...
          >
            DevGathering is MLSA MIET's flagship 36-hour hackathon, where
            students, ideas, and code converge from colleges across the region.
            Build fast, collaborate fearlessly, and create something
            unforgettable.
          </motion.p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-7">
          {FEATURES.map((feat, i) => (
            <div
              key={feat.number}
              className="flex flex-row md:flex-row items-stretch flex-1 min-w-0"
            >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, #5BA4E660, transparent)",
            }}
          />
          <p
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, #FFD6E860, transparent)",
            }}
          />
        </motion.div>
      </div>
